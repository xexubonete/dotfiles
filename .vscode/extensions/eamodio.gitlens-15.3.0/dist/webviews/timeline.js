...
`;var pa=Object.defineProperty,ga=Object.getOwnPropertyDescriptor,fa=(e,t,i,o)=>{for(var s,r=o>1?void 0:o?ga(t,i):t,a=e.length-1;a>=0;a--)(s=e[a])&&(r=(o?s(t,i,r):s(r))||r);return o&&r&&pa(t,i,r),r};let ma=class extends lit_element_s{firstUpdated(){"alert"===this.appearance&&queueMicrotask((()=>this.button.focus()))}render(){if(null==this.state)return void(this.hidden=!0);this.hidden=!1;const e="alert"===(this.appearance??"alert")?"alert":Ps;switch(this.state){case la.VerificationRequired:return As`
	...
	`,Aa([zs("#popover")],Ra.prototype,"body",2),Aa([zs("sl-popup")],Ra.prototype,"popup",2),Aa([Vs({reflect:!0})],Ra.prototype,"placement",2),Aa([Vs({type:Object})],Ra.prototype,"anchor",2),Aa([Vs({reflect:!0,type:Boolean})],Ra.prototype,"disabled",2),Aa([Vs({type:Number})],Ra.prototype,"distance",2),Aa([Vs({reflect:!0,type:Boolean})],Ra.prototype,"open",2),Aa([Vs({type:Number})],Ra.prototype,"skidding",2),Aa([Vs()],Ra.prototype,"trigger",2),Aa([Vs({type:Boolean})],Ra.prototype,"hoist",2),Aa([Ca("open",{afterFirstUpdate:!0})],Ra.prototype,"handleOpenChange",1),Aa([Ca(["distance","hoist","placement","skidding"])],Ra.prototype,"handleOptionsChange",1),Aa([Ca("disabled")],Ra.prototype,"handleDisabledChange",1),Ra=Aa([Fs("gl-popover")],Ra);var Pa=Object.defineProperty,_a=Object.getOwnPropertyDescriptor,Ta=(e,t,i,o)=>{for(var s,r=o>1?void 0:o?_a(t,i):t,a=e.length-1;a>=0;a--)(s=e[a])&&(r=(o?s(t,i,r):s(r))||r);return o&&r&&Pa(t,i,r),r};let Da=class extends lit_element_s{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){return null==this.subscription?0:ha(this.subscription,"days")??0}get state(){return this.subscription?.state}render(){return As`
		...
		</div>`}renderPopoverContent(){if(null==this.subscription)return Ps;let e;switch(this.state){case la.Paid:e=As`<p>
					Your
