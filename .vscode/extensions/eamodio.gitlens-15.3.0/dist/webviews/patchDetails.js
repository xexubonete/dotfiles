...
`),gr=[ur,wt``],mr=[ur,wt`
	...
	`,Ir([bi({type:Number})],Br.prototype,"lines",2),Br=Ir([fi("skeleton-loader")],Br);class GlTreeBase extends GlElement{renderLoading(){return oi`
