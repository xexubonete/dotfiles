...
`),172,(e=>e.$isActive&&(0,I.css)(Ve||(Ve=_e`
      &::before {
        content: '';
        position: absolute;
        bottom: 0;
    ...
    `)))),We=O()(o.Link)(Ne||(Ne=_e`
  position: relative;
  display: flex;
  width: ${0};
  flex: 1;
`),(e=>e.width)),Fe=O().div(He||(He=_e`
  width: 100%;
  display: flex;
  gap: 0.5rem;
  align-items: center;
  ...
  ${0}
`),(e=>e.$isPreviewTab?"italic":""),(e=>e.$isDirty&&(0,I.css)(Se||(Se=_e`
      .tab-close-icon {
        display: none;
      }
